package com.controller.dealerservice.controller;
...
import com.controller.dealerservice.model.PaymentList;
...
public class DealerController {
	...
	//alldealers
	@RequestMapping("/listdealers")
	public DealerList getAllCrop()
	{
	...
	@Autowired
	public com.controller.dealerservice.repository.PaymentRepository repo;
	
	@PostMapping("/pay")
	public Payment doPayment(@RequestBody Payment payment) {
		String cid = payment.getcid();
		System.out.println(cid);
		return dealerService.doPay(payment);
		
	}
	@RequestMapping("/listpayment")
	public PaymentList getAllPayment()
	{
		return dealerService.getAllPayments();
	}
